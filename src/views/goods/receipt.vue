<template>
  <div class="app-container release">
    <div class="filter-container">
      <el-input style="width: 200px;" class="filter-item" placeholder="编号"></el-input>
      <el-input style="width: 200px;" class="filter-item" placeholder="发货人"></el-input>
      <el-input @keyup.enter.native="handleFilter" style="width: 200px;" class="filter-item" placeholder="承运车牌号" v-model="listQuery.name">
      </el-input>
      <!--<div class="filter-item el-input el-input--medium" style="width: 40px; text-align: right;">状态</div>-->
      <el-select clearable placeholder="审核状态" style="width: 140px" class="filter-item" v-model="listQuery.orgCode">
        <el-option
...
export default {
  ...
  methods: {
    handleDetails(item) {
      this.$router.push({ name: 'receiptDetails', query: { id: item.id }})
    },
    // 选中行
