<template>
  <el-dialog title="选择线路运价" width="900px" class="historyDialog" :visible.sync="isActive" :before-close="dialogClose">
    <div class="search">
      <el-input class="keyword" style="width: 200px;" v-model="listQuery.keyWords" placeholder="线路名称"
    ...
    >
      ...
      <el-table-column
        property="postWareName"
        label="发货仓库"
        width="150">
      </el-table-column>
      <el-table-column
        property="reciverWareName"
        label="收货仓库"
        width="150">
      </el-table-column>
      <el-table-column
      ...
      <el-table-column
        property="shipperPrice"
        label="货主运价">
      </el-table-column>
      <el-table-column
        property="driverPrice"
        label="车主运价"
      >
      </el-table-column>
    </el-table>
...
<script>
import { page } from '@/api/base/line'
  ...
  methods: {
    ...
    getList() {
      const httpParams = {
        ...
        postWareId: this.postWareId,
        reciveWareId: this.reciveWareId
      }
      page(httpParams).then(response => {
