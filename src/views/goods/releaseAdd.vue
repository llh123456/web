  ...
  <div class="app-container">
    <el-form :model="form" :rules="rules" ref="form" label-width="120px">
      <!--<div class="header-form-container">
        <div class="state">NO.2018124564555</div>
      </div>-->
      <div class="tableTitle" style="margin-top: 0;">货源信息</div>
      ...
      <div class="footerBox">
        <el-button type="primary" :loading="minloading" @click="createData">创建</el-button>
      </div>
    </el-form>
...
import { goodsAll, packageAll, addObj } from '@/api/goods/goods'
